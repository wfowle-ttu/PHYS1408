...
$$
\newline
\theta = \tan^{-1}{\frac{\lvert{y}\rvert{}}{\lvert{x}\rvert{}}} \newline
\newline
...
![A figure demonstrating the "right hand rule"](Chapter2Figure21.png)
...
$$
\newline
\frac{d}{dt}(\overrightarrow{\mathbf{A}} \times \overrightarrow{\mathbf{B}}) = \frac{d\overrightarrow{\mathbf{A}}}{dt} \times \overrightarrow{\mathbf{B}} + \overrightarrow{\mathbf{A}}
 \times \frac{d\overrightarrow{\mathbf{B}}}{dt}
\newline
$$
...
\newline
\newline
\hat{\mathbf{k}} \times \hat{\mathbf{k}} = -\hat{\mathbf{i}} \times \hat{\mathbf{k}} = \hat{\mathbf{j}}
\newline
$$
...
$$
\newline
\overrightarrow{\mathbf{A}} \times (-\overrightarrow{\mathbf{B}}) = -\overrightarrow{\mathbf{A}} \times \overrightarrow{\mathbf{B}}
\newline
$$
...
$$
\overrightarrow{\mathbf{A}} \times \overrightarrow{\mathbf{B}} = \begin{vmatrix} \hat{\mathbf{i}} & \hat{\mathbf{j}} & \hat{\mathbf{j}} \\ 
A_x & A_y & A_z \\ 
B_x & B_y & B_z \end{vmatrix} =  \begin{vmatrix} A_y & A_z \\ B_y & B_z\end{vmatrix}\hat{\mathbf{i}}+\begin{vmatrix}A_z & A_x \\ B_z & B_x \end{vmatrix}\hat{\mathbf{j}} + \begin{vmatrix}A_x & A_y \\ B_x & B_y\end{vmatrix}\hat{\mathbf{k}}
$$
...
$$
\newline
\overrightarrow{\mathbf{A}} \times \overrightarrow{\mathbf{B}} = 2\hat{\mathbf{i}} \times (-\hat{\mathbf{i}}) + 2\hat{\mathbf{i}} \times 2\hat{\mathbf{j}} + 3\hat{\mathbf{j}} \times -\hat{\mathbf{i}} + 3\hat{\mathbf{j}} \times 2\hat{\mathbf{j}}
$$
...
$$
\newline
2\hat{\mathbf{i}} \times 2\hat{\mathbf{j}} + 3\hat{\mathbf{j}} \times -\hat{\mathbf{i}}
$$
...
\newline
\newline
R_x = (A_y \cdot B_z) - (A_z \cdot B_y) \newline
R_y = (A_z \cdot B_x ) - (A_x \cdot B_z) \newline
R_z = (A_x \cdot B_y) - (A_y \cdot B_x) \newline
\newline
$$
...
$$
\newline
\begin{vmatrix} R_x \\ R_y \\ R_z \end{vmatrix} = \begin{vmatrix}\hat{\mathbf{i}} & 2 & -1 \\ \hat{\mathbf{j}} & 3 & 2 \\ \hat{\mathbf{k}} & 0 & 0\end{vmatrix}
\newline
$$
...
$$
\newline
R_x = (3 \cdot 0) - (0 \cdot 2) \newline
R_y = (0 \cdot -1) - (2 \cdot 0) \newline
R_z = (2 \cdot 2) - (3 \cdot -1) \newline
\newline
$$

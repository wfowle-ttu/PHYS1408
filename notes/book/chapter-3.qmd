---
title: "Chapter 3 - Motion in One Dimension"
---
...
![A representation of that graphically](Chapter3Figure1.png)
...
$$
\newline
\Delta{x} = X_f - X_i = 100-25 = 75m = \Delta{x}
\newline
\Delta{t} = 45s+10s = 55s \newline
\newline
$$
...
![A figure showing us changing the position of B to become closer to A](Chapter3Figure2.png)

The above figure is effectively:

$$
\newline
v_x \equiv \lim\limits_{\Delta{t} \to 0} \frac{\Delta{x}}{\Delta{t}}
\newline
$$
...
![Figure depicting the graphical relations of average accleration and instant acceleration](Chapter3Figure5.png)
...
![The graphical relationship](Chapter3Figure6.png)
